...
format: html
resources:
  - assets/notebooks/chapter5_jit.ipynb
  - assets/notebooks/chapter9_prng.ipynb
  - assets/notebooks/chapter10.ipynb
  - assets/images/The_Cat.jpg
filters:
  - shinylive
---
...
![Save this image as "The_Cat.jpg"](assets/images/The_Cat.jpg)

```{=html}
<a href="assets/notebooks/chapter5_jit.ipynb" download="chapter5_jit.ipynb" class="btn btn-primary" role="button">
    <i class="bi bi-download"></i> JAX JIT Compilation (.ipynb)
</a>
```

```{=html}
<a href="assets/notebooks/chapter9_prng.ipynb" download="chapter9_prng.ipynb" class="btn btn-primary" role="button">
    <i class="bi bi-download"></i> JAX Random Numbers (.ipynb)
</a>
```

```{=html}
<a href="assets/notebooks/chapter10.ipynb" download="chapter10.ipynb" class="btn btn-primary" role="button">
