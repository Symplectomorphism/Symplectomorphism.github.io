...
- Dominance is conditional on this feasible set and these metrics. A non-dominated point is not a certificate of practical desirability.
...
- Packaging includes orbital design as well as the physical arrangement of instruments.
...
## Six Architectural Decision Patterns {.smaller}
...
Evaluate the subset's **synergy**, **interference**, and **redundancy** against the mission requirements.
...
Compare encodings by how easily they support feasible candidate generation and search.
...
For a fixed computation budget, evaluating more architectures leaves less time for each model evaluation.
...
- Report heuristic results with the search budget, assumptions, and remaining uncertainty about better alternatives.
