...
## Reasoning about Tradespace Results {.smaller}
...
- Tradespace analysis can improve both the architecture selection and the process used to make it.
...
## Interpreting Feature Frequencies {.smaller}
...
## Sensitivity to Model Assumptions {.smaller}
...
- “Probability 1.0” here means all probability mass in this finite model satisfies the threshold, not a guarantee under every possible practical event.
...
::: {.notes}
- The ordered decision set also provides a model for planning and coordinating architectural studies.
...
## Revising the Decision Model {.smaller}
...
## Steps in Tradespace Analysis {.smaller}
