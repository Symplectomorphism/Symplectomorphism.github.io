...
:::
::: {.column width="57%"}
![](assets/chapter02/fig2_11_formal_functional.png){width=100% fig-align="center"}

::: {.side-caption}
Thin double-headed arrows show formal structure; broader arrows show functional current flow. Source: Crawley, Cameron & Selva (2016), Fig. 2.11.
:::
:::
:::
...
## N-Squared Tables Separate Structure from Interaction {.smaller}

The relationship diagram is intuitive; the paired N×N views preserve detail as relationships proliferate.

::: {.columns}
::: {.column width="50%"}
![](assets/chapter02/table2_5_formal.png){width=100% fig-align="center"}

::: {.side-caption}
Formal relationships: stable electrical connections.
:::
:::
::: {.column width="50%"}
![](assets/chapter02/table2_5_functional.png){width=100% fig-align="center"}

::: {.side-caption}
Functional relationships: exchanges of current.
:::
:::
:::

::: {.fragment .callout-note appearance="simple" icon=false title="Reading the boundary"}
Dashed row and column lines separate system entities from Input and Output context; populated cells across those lines are **external interfaces**.
:::
...
- **Read Table 2.5 explicitly**: Resistor 1, Resistor 2, and the operational amplifier lie above and left of the dashed boundary; Input and Output are context entities. Relationships that cross those dashed lines are external interfaces.
