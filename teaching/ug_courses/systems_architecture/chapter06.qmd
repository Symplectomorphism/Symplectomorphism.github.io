...
- A good architecture (lots of desired function, minimal form) is nearly synonymous with good value: maximizes benefit-to-cost by definition. This is why "elegant"/"efficient" mappings matter later: not aesthetics, value
:::
...
::: {.side-caption}
**Question 6a** connects the analyses of form and function from Chapters 4 and 5.
:::
...
::: {.notes}
- Ask students which category describes the interaction represented by each link.
