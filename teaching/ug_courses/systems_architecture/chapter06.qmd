...
**Suggested answer:** A hose carries water as a matter flow; a shaft transmits mechanical work and torque as an energy/mechanical interaction; a hot surface transfers thermal energy; a sensor cable carries a measurement signal as information; an instruction can convey a command or a belief. The same physical interface can carry several interaction types, such as a cable supplying power and data. Name the specific exchanged quantity and its required properties rather than labeling every link merely “connected.”
