...
&=4262\frac{(s+5.4086)(s-0.3668)(s+0.2533)}{(s+96.4235)(s-66.2137)(s+4.7902)
}.
\end{aligned}$$
...
The closed-loop system $\dfrac{KG_{c}(s)G_{X}(s)}{1+KG_{c}(s)G_{X}(s)}$ is stable only for $$-1.02<-1/K<-0.981\text{\ \textbf{or} \ }\frac{1}{1.02}=0.980\,<K<1.019=
\frac{1}{0.981}!$$ The phase margin is only of the order $\tan ^{-1}(0.02/1)=0.02$ radians **or** $1.15$ degrees!
:::
...
$$\begin{array}{ll}
|S(j\omega )|>1\text{\ (0 dB)} & \text{for}\omega >0.25\text{} \\
|S(j\omega )|>10\text{\ (20 dB)} & \text{for}1<\omega <25 \\
\max\limits_{\omega }|S(j\omega )|=66.8\text{\ (}36.5\text{dB)} & \text{for}\omega =5.
\end{array}$$
:::
